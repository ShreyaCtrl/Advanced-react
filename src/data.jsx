...
export const people = [
  { id: 1, name: "john", age: 24, hobby: 'binge watching tv' },
  { id: 2, name: "peter", age: 20, hobby: 'sleeping' },
  { id: 3, name: "susan", age: 25, hobby: 'eating' },
  { id: 4, name: "anna", age: 27, hobby: 'reading books' }
];
